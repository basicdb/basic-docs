...
# Using the database
You can use the REST API to read and write to the user's database. Checkout the [API Reference](/api-reference/project-users/create-a-new-item-in-the-users-database) to get started.
