...
Basic uses OAuth 2.0 for authentication. For more details on OAuth 2.0, read more about [Introduction to OAuth 2.0](/others/auth-basic#introduction-to-oauth-2-0), or a [pseudocode example](/others/auth-basic#pseudocode-example).
