...
---
<Info>
    For local-first benefits like built-in offline and multiplayer support, please use the [Basic SDK](/get-started/implement-basic/using-react)
</Info>
# Summary
...
Basic uses OAuth 2.0 for authentication. For more details, read about [Basic Auth](/others/auth-basic#introduction-to-oauth-2-0).

<Steps>
    <Step title="Redirect user to /authorize">
        Create a button that redirects the user to the Basic Auth page, with the following required parameters (more info on [required parameters](/others/auth-basic#required-parameters)):
