...
# Update Basic library
If you need to update your Basic library, you can easily do so by running the following command via the terminal in your project directory:
