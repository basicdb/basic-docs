...
<Steps>
  <Step title="Create a new React project">
    ...
    And finally choose the JavaScript variant.
...
<Steps>
  <Step title="Add the BasicProvider to main.jsx">
    ...
    <Info>Replace YOUR_PROJECT_ID with your Project ID from the Basic dashboard. To create one, follow the instructions for [signing up](/get-started/sign-up-for-basic).</Info>
    ```jsx main.jsx
  ...
  <Step title="Add a login button to App.jsx">
...
# Using the database
You can use the React SDK to read and write to the user's database. Checkout the [React SDK docs](/sdk-reference/react-sdk) to get started.