---
title: 'Set up the Basic CLI (optional)'
description: 'Using the CLI or code editor LLMs to manage projects.'
---
...
If you run `basic init` in a codebase with an existing `basic.config.ts` file (e.g., created using via [create-lofi-app](/basic-react/create-lofi-app)), you'll notice that the project_id in your `basic.config.ts` file gets automatically updated.
# Other CLI commands
