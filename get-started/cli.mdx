...
<Steps>
  ...
  <Step title="Create your project">
    Navigate to your project directory and run `basic create` to create your project. You will be prompted to enter a project name, and choose your project stack (Typescript, React, etc.).
    ```bash
    cd project-name
    ```
