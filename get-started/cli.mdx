...
If you run `basic init` in a codebase with an existing `basic.config.ts` file (e.g., created using via [create-lofi-app](/get-started/implement-basic/create-lofi-app)), you'll notice that the project_id in your `basic.config.ts` file gets automatically updated.
# Other CLI commands
