---
title: 'Schema'
description: 'How schemas work in Basic'
---
# Overview
...
It would follow this general format:
...
<ParamField query="namespace" type="string" required>
    This should match the name of your project. It can be found in the Basic dashboard, or will be auto-generated for you if you had used the CLI.
</ParamField>

### version
<ParamField query="version" type="int" required>
    ...
    <Note> Versionining of schemas is currently in development. This value should remain at 0.</Note>
</ParamField>
...
Tables also require three parameters:

### name
<ParamField query="name" type="string" required>
    Set this as the internal name for the tables for easy reference.
</ParamField>
...
### fields
<ParamField query="fields" type="object" required>
...
### type
<ParamField query="type" type="string" required>
    This is the data type of the field. Basic supports the following field types: `string`, `int`, `boolean`, `json`, `text`.
</ParamField>
