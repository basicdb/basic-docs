...
<ParamField query=".get('ID_OF_ITEM')">
    Fetch a single item from the table. Can be used with useQuery to "subscribe" to data changes
</ParamField>

<ParamField query=".getAll()">
    Fetch all items from the table. Can be used with useQuery to "subscribe" to data changes
</ParamField>
