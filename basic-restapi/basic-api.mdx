...
---
<Info>
    For built-in local-first benefits like offline support and instant UI, please use [create-lofi-app](/basic-react/create-lofi-app) or the [Basic SDK](/basic-react/basic-sdk). The API currently does not include these benefits.
</Info>
# Summary
