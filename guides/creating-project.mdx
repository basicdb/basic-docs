...
If you are using a React app, you can use the [react library](/guides/using-react) to get started.

Otherwise, you can use the [API](/guides/adding-auth.mdx) for any language.
