...
This contrasts with the traditional centralized ownership model of data.
...
Lets take the example of Google Docs. 
...
In traditional centralized data ownership models, user data is spread across multiple databases owned by different apps and websites. 
...
For example, if one day you stop paying for your Google Docs, you will likely not be able to (or are limited in the way you can) access your documents. 

Similarly, if Google decides to shut down Google Docs as a product (perhaps unlikely in the instance of Google Docs, but not unfathomable given their long history of sunsetting products), you will lose your information.
...
With PDS's, your data remains with you regardless of the availability of APIs or the shuttering of services. 
...
Basic enables developers to build apps without backend and data layers, and they can focus on building a better user experience.
