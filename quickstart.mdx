...
<Steps>
  <Step title="Go the Schema tab, and create a new table.">
  </Step>
  <Step title="You can now query all the documents in the table ">
...
For the `account_id` parameter, you can use "self".
