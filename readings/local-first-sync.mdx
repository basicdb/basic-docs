...
With Basic, you can avail these features in your applications for your users by [starting a new app](/basic-react/create-lofi-app) or [integrating Basic into your existing React app](/basic-react/basic-sdk).
...
# How to use local-first with Basic
  ...
  You can get started by [starting a new app](/basic-react/create-lofi-app) or [integrating Basic into your existing React app](/basic-react/basic-sdk).
